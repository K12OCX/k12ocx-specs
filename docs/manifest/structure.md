...
Further information about mapping the OERSchema classes to the terms used by specific providers is given in the section on [semantic markup](../../inpage/)
...
Further information about the resources could be provided here, such as the URL to locate the content (`sdo:url`) and the name (`sdo:name`) of the resource, however this would duplicate information in the sitemap used to [locate](../../manifest/locate) the resources, and embedded markup used to [describe](../../inpage) the resources.
